...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'billing_address.first_name' => ['required_if:billing_address.same_as_shipping,false', 'string', 'max:100'],
            'billing_address.last_name' => ['required_if:billing_address.same_as_shipping,false', 'string', 'max:100'],
            ...
            'billing_address.country' => ['required_if:billing_address.same_as_shipping,false', 'string', 'size:2'],
            ...
            'billing_address.street' => ['required_if:billing_address.same_as_shipping,false', 'string', 'max:255'],
            'billing_address.zip_code' => ['required_if:billing_address.same_as_shipping,false', 'string', 'max:20'],
